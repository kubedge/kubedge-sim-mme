...
docker-build-fsb-dev: vet
	...
	docker buildx build --platform=linux/adm64 . -f build/Dockerfile.mmesim-fsb -t ${IMG_BUSINESSLOGIC_DEV}
...
docker-build-gpb-dev: vet
	...
	docker buildx build --platform=linux/adm64 . -f build/Dockerfile.mmesim-gpb -t ${IMG_ENRICHMENT_DEV}
...
docker-build-lc-dev: vet
	...
	docker buildx build --platform=linux/adm64 . -f build/Dockerfile.mmesim-lc -t ${IMG_FRONTEND_DEV}
...
docker-build-ncb-dev: vet
	...
	docker buildx build --platform=linux/adm64 . -f build/Dockerfile.mmesim-ncb -t ${IMG_LOADBALANCER_DEV}
...
docker-build-fsb-amd64:
	...
	docker buildx build --platform=linux/adm64 . -f build/Dockerfile.mmesim-fsb.amd64 -t ${IMG_BUSINESSLOGIC_AMD64}
...
docker-build-gpb-amd64:
	...
	docker buildx build --platform=linux/adm64 . -f build/Dockerfile.mmesim-gpb.amd64 -t ${IMG_ENRICHMENT_AMD64}
...
docker-build-lc-amd64:
	...
	docker buildx build --platform=linux/adm64 . -f build/Dockerfile.mmesim-lc.amd64 -t ${IMG_FRONTEND_AMD64}
...
docker-build-ncb-amd64:
	...
	docker buildx build --platform=linux/adm64 . -f build/Dockerfile.mmesim-ncb.amd64 -t ${IMG_LOADBALANCER_AMD64}
...
docker-build-fsb-arm32v7:
	...
	docker buildx build --platform=linux/arm/v7 . -f build/Dockerfile.mmesim-fsb.arm32v7 -t ${IMG_BUSINESSLOGIC_ARM32V7}
...
docker-build-gpb-arm32v7:
	...
	docker buildx build --platform=linux/arm/v7 . -f build/Dockerfile.mmesim-gpb.arm32v7 -t ${IMG_ENRICHMENT_ARM32V7}
...
docker-build-lc-arm32v7:
	...
	docker buildx build --platform=linux/arm/v7 . -f build/Dockerfile.mmesim-lc.arm32v7 -t ${IMG_FRONTEND_ARM32V7}
...
docker-build-ncb-arm32v7:
	...
	docker buildx build --platform=linux/arm/v7 . -f build/Dockerfile.mmesim-ncb.arm32v7 -t ${IMG_LOADBALANCER_ARM32V7}
...
docker-build-fsb-arm64v8:
	...
	docker buildx build --platform=linux/arm64 . -f build/Dockerfile.mmesim-fsb.arm64v8 -t ${IMG_BUSINESSLOGIC_ARM64V8}
...
docker-build-gpb-arm64v8:
	...
	docker buildx build --platform=linux/arm64 . -f build/Dockerfile.mmesim-gpb.arm64v8 -t ${IMG_ENRICHMENT_ARM64V8}
...
docker-build-lc-arm64v8:
	...
	docker buildx build --platform=linux/arm64 . -f build/Dockerfile.mmesim-lc.arm64v8 -t ${IMG_FRONTEND_ARM64V8}
...
docker-build-ncb-arm64v8:
	...
	docker buildx build --platform=linux/arm64 . -f build/Dockerfile.mmesim-ncb.arm64v8 -t ${IMG_LOADBALANCER_ARM64V8}
